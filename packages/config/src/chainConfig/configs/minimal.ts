import {CELLS_PER_EXT_BLOB, MAX_REQUEST_BLOCKS_DENEB, PresetName} from "@lodestar/params";
...
export const chainConfig: ChainConfig = {
  ...
  // Fulu
  NUMBER_OF_COLUMNS: CELLS_PER_EXT_BLOB,
  NUMBER_OF_CUSTODY_GROUPS: 128,
  DATA_COLUMN_SIDECAR_SUBNET_COUNT: 128,
  // MAX_REQUEST_BLOCKS_DENEB * NUMBER_OF_COLUMNS
  MAX_REQUEST_DATA_COLUMN_SIDECARS: MAX_REQUEST_BLOCKS_DENEB * CELLS_PER_EXT_BLOB,
  SAMPLES_PER_SLOT: 8,
